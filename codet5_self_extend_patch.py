    ...
    def self_extend_forward(
        ...
        **kwargs,
        ...
        if past_key_value is not None:
            ...
            group_key_states = torch.cat([past_key_value[1], group_key_states], dim=2)
        ...
        merged_attn_weights = torch.where(neighbor_attention_mask.bool(), neighbor_attn_weights, group_attn_weights) 
